    ...
    <div class="container text-center text-md-left">
        ...
        <!--/.Second column-->
            ...
            <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mt-3">
                ...
                <p><i class="fa fa-envelope mr-3"></i> hhi@hhi.institute</p>
                <p><i class="fa fa-phone mr-3"></i> IČO: 501 878 72</p>
                <p><i class="fa fa-print mr-3"></i>Právna forma: nezisková organizácia</p>
            </div>
            <!--/.Fourth column-->
        ...
        <div class="row py-3 d-flex align-items-center">
            ...
            <div class="col-md-8 col-lg-8">
                ...
                <!--Copyright-->
                <p class="text-center text-md-left grey-text">© 2018 Human Health Institute
                {{--<a href="https://mdbootstrap.com/material-design-for-bootstrap/"><strong>--}}
