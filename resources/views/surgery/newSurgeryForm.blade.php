                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="" id="confirm" name="confirm"
                                       required>
                                <label class="form-check-label" for="confirm">
                                    {!!  trans('app.confirm', ['url'=>url('privacy')])  !!}
                                </label>
                            </div>
                        </div>
                    </div>
